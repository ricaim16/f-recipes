...
import { FaChevronDown, FaBookmark, FaUser } from "react-icons/fa";
...
export const Navbar = () => {
  ...
  const userId = "your-user-id"; // Replace this with actual logic to get userId
    ...
    if (file) {
      ...
      try {
        const response = await axios.post(
          `http://localhost:3001/auth/upload/${userId}`, // Ensure this matches your server route
          formData,
          {
            headers: {
              "Content-Type": "multipart/form-data", // Normally, axios sets this automatically
              Authorization: `Bearer ${token}`,
            },
          }
        );
